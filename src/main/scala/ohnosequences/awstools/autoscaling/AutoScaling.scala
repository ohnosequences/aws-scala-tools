...
class AutoScaling(val as: AmazonAutoScaling, val ec2: EC2) { autoscaling =>
  ...
  // def fixAutoScalingGroupUserData[AG <: AnyAutoScalingGroup](group: AG, fixedUserData: String): AG = {
  //   val launchConfig = group.launchConfiguration
  //   val launchSpecs = launchConfig.launchSpecs
  //
  //   AutoScalingGroup(
  //     LaunchConfiguration(
  //       launchConfig.name,
  //       launchConfig.purchaseModel,
  //       LaunchSpecs(launchSpecs.instanceSpecs)(
  //         launchSpecs.keyName,
  //         fixedUserData, // <-- !!!
  //         launchSpecs.instanceProfile,
  //         launchSpecs.securityGroups,
  //         launchSpecs.instanceMonitoring,
  //         launchSpecs.deviceMapping
  //       )
  //     )
  //   )(group.name,
  //     group.minSize,
