...
/**
 * Utils implementation that signs requests with the AWS4 signing protocol.
 */
public class FakeAWSV4 extends AbstractAWSSigner {
    ...
    /* (non-Javadoc)
     * @see com.amazonaws.auth.Utils#sign(com.amazonaws.Request, com.amazonaws.auth.AWSCredentials)
     */
    public void sign(Request<?> request, AWSCredentials credentials) throws AmazonClientException {
       ...
       // System.out.println(new String(Base64.encodeBase64(kSecret)));
        byte[] kDate    = sign(dateStamp, kSecret, SigningAlgorithm.HmacSHA256);
      //  System.out.println(new String(Base64.encodeBase64(kDate)));
        byte[] kRegion  = sign(regionName, kDate, SigningAlgorithm.HmacSHA256);
       // System.out.println(new String(Base64.encodeBase64(kRegion)));
