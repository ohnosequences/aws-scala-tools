 ...
 */
public class FakeAWSV2 extends AbstractAWSSigner implements Signer {
    ...
    private String calculateStringToSignV2(Request<?> request) throws AmazonClientException {
       ...
       // System.out.println(getCanonicalizedQueryString(parameters));
        return data.toString();
    }
